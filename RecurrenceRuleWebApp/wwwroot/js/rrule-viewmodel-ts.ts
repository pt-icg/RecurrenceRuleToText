...
class RruleViewModel {
    ...
    public weekDays: ObservableArray<HtmlTagItem>
    public toggleWeekDays: Function

    public monthlyOptions: Observable<string>
    public monthDays: ObservableArray<HtmlTagItem>
    public toggleMonthDays: Function
    public monthByDayPos: ObservableArray<HtmlTagItem>
    public selectedMonthByDayPos: Observable<HtmlTagItem>
    public monthByDayPosName: ObservableArray<HtmlTagItem>
    public selectedMonthByDayPosName: Observable<HtmlTagItem>

    public yearlyOptions: Observable<string>
    public yearlyByMonth: ObservableArray<HtmlTagItem>
    public selectedYearlyByMonth: Observable<HtmlTagItem>
    public yearlyByMonthDay: ObservableArray<HtmlTagItem>
    public selectedYearlyByMonthDay: Observable<HtmlTagItem>
    public yearlyMultipleMonths: ObservableArray<HtmlTagItem>
    public toggleYearlyMultipleMonths: Function
    public yearlyBySetPos: ObservableArray<HtmlTagItem>
    public selectedYearlyBySetPos: Observable<HtmlTagItem>
    public yearlyByDay: ObservableArray<HtmlTagItem>
    public selectedYearlyByDay: Observable<HtmlTagItem>
    public yearlyByMonthWithBySetPosByDay: ObservableArray<HtmlTagItem>
    public selectedYearlyByMonthWithBySetPosByDay: Observable<HtmlTagItem>

    public everyRuleInterval: Observable<number>

    public endRule: ObservableArray<HtmlTagItem>
    public selectedEndRule: Observable<HtmlTagItem>
    public endRuleOccurrences: Observable<number>
    public endRuleUntil: Observable<string>

    public rruleCode: Observable<string>
    public rruleText: Observable<string>
    public rruleOutput: ObservableArray<string>

    //rruleerror, rrulehint
    public rruleError: Observable<string>
    public rruleHint: Observable<string>
    ...
    constructor() {
        ...
        for (let i = days; i--;) monthDayArray[i] = new HtmlTagItem((i + 1).toString(), (i + 1).toString(), false);
        ...
        for (let i = days; i--;) yearlyByMonthDayArray[i] = new HtmlTagItem((i + 1).toString(), (i + 1).toString(), false);
    ...
    private toggleButtonItem(item, observableArray) {
